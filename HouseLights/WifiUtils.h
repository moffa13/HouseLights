...
namespace WifiUtils {
	...
	bool connect(String essid, String password, bool blocking = true, unsigned timeout = 15, IPAddress const * const ip = nullptr, IPAddress const * const gateway = nullptr, IPAddress const * const subnet = nullptr);
